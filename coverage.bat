...
set REPORTGEN_VER="5.2.0"
set DOTNET_VER="8.0"

set REPORTGEN_PATH="%USERPROFILE%\.nuget\packages\ReportGenerator\%REPORTGEN_VER%\tools\net%DOTNET_VER%\ReportGenerator.exe"

echo "ReportGenerator %REPORTGEN_PATH%"
...
%REPORTGEN_PATH% -filefilters:%REPORT_FILE_FILTERS% -targetdir:%OUTPUT_DIR% -historydir:%HISTORY_DIR% -reports:%COVERAGE_RESULT% -reporttypes:%REPORTTYPES%
